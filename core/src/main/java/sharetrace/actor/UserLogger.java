...
import sharetrace.util.logging.event.ContactsRefreshEvent;
import sharetrace.util.logging.event.CurrentRefreshEvent;
...
import sharetrace.util.logging.event.SendCachedEvent;
import sharetrace.util.logging.event.SendCurrentEvent;
