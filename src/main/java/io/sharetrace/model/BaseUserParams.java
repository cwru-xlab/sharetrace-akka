...
abstract class BaseUserParams {
   ...
   *
   * <p>Given a positive transmission rate, a positive coefficient guarantees that {@link
   ...
   *
   * <p>A nonzero value can account for delays in symptom onset and initial {@link UserActor}
   * communication.
   */
