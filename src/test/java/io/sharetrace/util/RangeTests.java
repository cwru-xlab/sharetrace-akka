...
public class RangeTests {
  ...
  @Test
  public void bigDecimalSingle() {
    Assertions.assertEquals(
        Ranges.expectedBigDecimalSingle(), Ranges.toList(Ranges.bigDecimalSingle()));
  }
  ...
  public void doubleSingle() {
    Assertions.assertEquals(Ranges.expectedDoubleSingle(), Ranges.toList(Ranges.doubleSingle()));
  }
  ...
  @Test
  public void floatSingle() {
    Assertions.assertEquals(Ranges.expectedFloatSingle(), Ranges.toList(Ranges.floatSingle()));
  }
  ...
  @Test
  public void longSingle() {
    Assertions.assertEquals(Ranges.expectedLongSingle(), Ranges.toList(Ranges.longSingle()));
  }
  ...
  @Test
  public void intSingle() {
    Assertions.assertEquals(Ranges.expectedIntSingle(), Ranges.toList(Ranges.intSingle()));
  }
  ...
  public void shortSingle() {
    Assertions.assertEquals(Ranges.expectedShortSingle(), Ranges.toList(Ranges.shortSingle()));
  }
  ...
  @Test
  public void byteSingle() {
    Assertions.assertEquals(Ranges.expectedByteSingle(), Ranges.toList(Ranges.byteSingle()));
  }
